...
"!!!! Enhanced Python stuff

hi pythonStatement    ctermfg=220 ctermbg=NONE cterm=bold
hi pythonRepeat       ctermfg=220 ctermbg=NONE cterm=bold
hi pythonConditional  ctermfg=220 ctermbg=NONE cterm=bold
hi pythonOperator     ctermfg=220 ctermbg=NONE cterm=bold
hi pythonBuiltinFunc  ctermfg=202 ctermbg=NONE cterm=bold
hi pythonExClass      ctermfg=196 ctermbg=NONE cterm=bold
hi pythonException    ctermfg=196 ctermbg=NONE cterm=bold
hi pythonBuiltinObj   ctermfg=202 ctermbg=NONE cterm=bold
hi pythonBoolean      ctermfg=202 ctermbg=NONE cterm=bold
hi pythonImport       ctermfg=82  ctermbg=NONE cterm=bold
hi pythonFunction     ctermfg=38 ctermbg=NONE cterm=bold
hi pythonDottedName   ctermfg=123 ctermbg=NONE cterm=bold
" All the Python related stuff 

hi Number      ctermfg=207  ctermbg=NONE  cterm=NONE
hi Float       ctermfg=207  ctermbg=NONE  cterm=NONE
...
hi Include     ctermfg=82  ctermbg=NONE  cterm=bold
